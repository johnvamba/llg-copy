...
(function () {
  ...
  function N(k, l) {
    ...
    }[k || "solid"]) for (var s = 0; s < v.length; s++) {
      v[s] *= l;
    } else v = [];
    return v;
  }
  ...
  function La() {
    for (var k = null, l = 0; l < arguments.length; l++) {
      k = arguments[l], k.style && (k.style.display = "inline");
    }
  }

  function ua() {
    for (var k = null, l = 0; l < arguments.length; l++) {
      (k = arguments[l]) && k.style && (k.style.display = "none");
    }
  }
  ...
  function ya(k, l) {
    ...
    if (s(this.options.margin) && k.options.subtitles) for (var v = k.options.subtitles, t = 0; t < v.length; t++) {
      if ((s(v[t].horizontalAlign) && "center" === this.horizontalAlign || v[t].horizontalAlign === this.horizontalAlign) && (s(v[t].verticalAlign) && "top" === this.verticalAlign || v[t].verticalAlign === this.verticalAlign) && !v[t].dockInsidePlotArea === !this.dockInsidePlotArea) {
        this.margin = 0;
        break;
      }
    }
  ...
  (function () {
    J.fSDec = function (k) {
      for (var l = "", v = 0; v < k.length; v++) {
        l += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(v));
      }
  ...
  var Ya = {},
    ...
    for (R = F = L = J = N = 0; 0 < M.length;) {
      if (l = M.pop(), "#" === l || "0" === l) {
        if (N++, N === Q) {
          var W = E,
              E = [];
          if ("0" === l) for (l = Q - J - (W ? W.length : 0); 0 < l;) {
            W.unshift("0"), l--;
          }

          for (; 0 < W.length;) {
            v = W.pop() + v, R++, 0 === R % F && L === P && 0 < W.length && (v = w + v);
          }
    ...
    for (M = !1; 0 < I.length;) {
      l = I.shift(), "#" === l || "0" === l ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(), M = !0) : "0" === l && (w += "0", M = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? w += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? w += l : (l = 0 > V ? l.replace("+", "").replace("-", "") : l.replace("-", ""), w += l.replace(/[0]+/, function (a) {
        return X(V, a.length);
      }));
    }
    ...
    !0 === Q && (k.save(), k.beginPath(), k.moveTo(s, v), k.lineTo(s - J, v + J), k.lineTo(s - J, t - J), k.lineTo(s, t), E = k.createLinearGradient(s - J, (t + v) / 2, s, (t + v) / 2), E.addColorStop(0, w), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = E, E.addColorStop(0, w), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), k.fillStyle = E, k.fill(), k.closePath(), k.restore());
      ...
      Y = function Y(k) {
    for (var l = "", s = 0; s < k.length; s++) {
      l += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(s));
    }
  ...
  V.prototype.setOptions = function (k, l) {
    if (qa[this._defaultsKey]) {
      ...
      for (t in s) {
        "publicProperties" !== t && s.hasOwnProperty(t) && (this[t] = k && t in k ? k[t] : l && t in l ? l[t] : s[t]);
      }
  ...
  V.prototype.removeEventListener = function (k, l) {
    if (k && l && this._eventListeners[k]) for (var s = this._eventListeners[k], t = 0; t < s.length; t++) {
      if (s[t].eventHandler === l) {
        s[t].splice(t, 1);
        break;
      }
    }
  ...
  V.prototype.dispatchEvent = function (k, l, s) {
    if (k && this._eventListeners[k]) {
      ...
      for (var t = this._eventListeners[k], w = 0; w < t.length; w++) {
        t[w].eventHandler.call(t[w].context, l);
      }
    }
  ...
  ja.prototype.render = function (k) {
    if (0 !== this.fontSize) {
      ...
      for (s = 0; s < this._wrappedText.lines.length; s++) {
        F = this._wrappedText.lines[s], "right" === this.horizontalAlign ? t = this.width - F.width - this.rightPadding : "left" === this.horizontalAlign ? t = this.leftPadding : "center" === this.horizontalAlign && (t = (this.width - (this.leftPadding + this.rightPadding)) / 2 - F.width / 2 + this.leftPadding), this.ctx.fillText(F.text, t, w), w += F.height;
      }
  ...
  w = Pa.Chart = function () {
    ...
    l.prototype.setLayout = function () {
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
          if (!this.data[d].axisYType || "primary" === this.data[d].axisYType) if (this.options.axisY && 0 < this.options.axisY.length) {
            if (!this.axisY.length) for (var c = 0; c < this.options.axisY.length; c++) {
              "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "bottom"));
            }
          ...
          if ("secondary" === this.data[d].axisYType) if (this.options.axisY2 && 0 < this.options.axisY2.length) {
            if (!this.axisY2.length) for (c = 0; c < this.options.axisY2.length; c++) {
              "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"));
            }
          ...
          if (!this.data[d].axisXType || "primary" === this.data[d].axisXType) if (this.options.axisX && 0 < this.options.axisX.length) {
            if (!this.axisX.length) for (c = 0; c < this.options.axisX.length; c++) {
              "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
            }
          ...
          if ("secondary" === this.data[d].axisXType) if (this.options.axisX2 && 0 < this.options.axisX2.length) {
            if (!this.axisX2.length) for (c = 0; c < this.options.axisX2.length; c++) {
              "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "right"));
            }
      ...
      if (this.options.subtitles) for (d = 0; d < this.options.subtitles.length; d++) {
        c = new Ia(this, this.options.subtitles[d], d), this.subtitles.push(c), c.dockInsidePlotArea ? a.push(c) : c.setLayout();
      }
    ...
    l.prototype.renderElements = function () {
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++) {
        for (var f = this.plotInfo.plotTypes[d], n = 0; n < f.plotUnits.length; n++) {
          var m = f.plotUnits[n],
              A = null;
          m.targetCanvas = null;
          ...
          for (var h = 0; h < m.dataSeriesIndexes.length; h++) {
            this._dataInRenderedOrder.push(this.data[m.dataSeriesIndexes[h]]);
          }
      ...
      if (0 < c.length) r.disableToolTip = !0, r._animator.animate(200, r.animationDuration, function (a) {
        ...
        if (r._breaksCanvas) if (t) r.plotArea.ctx.drawImage(r._breaksCanvas, 0, 0, this.width, this.height);else for (h = 0; h < r._axes.length; h++) {
          r._axes[h].createMask();
        }
      ...
      for (h = 0; h < this._axes.length; h++) {
        this._axes[h].maskCanvas && (delete this._axes[h].maskCanvas, delete this._axes[h].maskCtx);
      }
    };
    ...
    l.prototype.categoriseDataSeries = function () {
      for (var a = "", d = 0; d < this.data.length; d++) {
        if (a = this.data[d], a.dataPoints && 0 !== a.dataPoints.length && a.visible && 0 <= l._supportedChartTypes.indexOf(a.type)) {
          for (var c = null, b = !1, e = null, f = !1, n = 0; n < this.plotInfo.plotTypes.length; n++) {
            if (this.plotInfo.plotTypes[n].type === a.type) {
              b = !0;
          ...
          for (n = 0; n < c.plotUnits.length; n++) {
            if (c.plotUnits[n].axisYType === a.axisYType && c.plotUnits[n].axisXType === a.axisXType && c.plotUnits[n].axisYIndex === a.axisYIndex && c.plotUnits[n].axisXIndex === a.axisXIndex) {
              f = !0;
              e = c.plotUnits[n];
              break;
            }
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++) {
        for (c = this.plotInfo.plotTypes[d], n = a = 0; n < c.plotUnits.length; n++) {
          c.plotUnits[n].previousDataSeriesCount = a, a += c.plotUnits[n].dataSeriesIndexes.length;
        }
      }
    };
    ...
    l.prototype._processStackedPlotUnit = function (a) {
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        ...
        for (p in n) {
          n.hasOwnProperty(p) && !isNaN(p) && (a = n[p], a < d.min && (d.min = Math.min(a, A)), a > d.max && (d.max = a), p < c.viewPortMin || p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, A)), a > d.viewPortMax && (d.viewPortMax = a)));
        }

        for (p in m) {
          m.hasOwnProperty(p) && !isNaN(p) && (a = m[p], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), p < c.viewPortMin || p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))));
        }
      }
    };
    ...
    l.prototype.calculateAutoBreaks = function () {
      ...
      function d(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
          ...
          if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
            ...
            if (!(4 > k.dataPoints.length)) for (q = 0; q < k.dataPoints.length; q++) {
              if (b && (p = (n + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() : k.dataPoints[q].x, p = Math.floor((g - h) / p), g < f[p].min && (f[p].min = g), g > f[p].max && (f[p].max = g)), c) {
                var l = (r + 1 - m) * Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold) || 10, 10) / 100;
                if ((g = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && g.length) for (var t = 0; t < g.length; t++) {
                  p = Math.floor((g[t] - m) / l), g[t] < d[p].min && (d[p].min = g[t]), g[t] > d[p].max && (d[p].max = g[t]);
                } else s(g) || (p = Math.floor((g - m) / l), g < d[p].min && (d[p].min = g), g > d[p].max && (d[p].max = g));
              }
            }
          }
        }
      ...
      function c(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (!(4 > m.dataPoints.length)) for (h = 0; h < m.dataPoints.length; h++) {
            g = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[h].x.getTime ? m.dataPoints[h].x.getTime() : m.dataPoints[h].x, g = Math.floor((b - c) / g), b < f[g].min && (f[g].min = b), b > f[g].max && (f[g].max = b);
          }
        }
      }

      for (var b, e = this, f = !1, n = 0; n < this._axes.length; n++) {
        if (this._axes[n].scaleBreaks && this._axes[n].scaleBreaks.autoCalculate && 1 <= this._axes[n].scaleBreaks.maxNumberOfAutoBreaks) {
          f = !0;
          this._axes[n].dataInfo._dataRanges = [];

          for (var m = 0; m < 100 / Math.max(parseFloat(this._axes[n].scaleBreaks.collapsibleThreshold) || 10, 10); m++) {
            this._axes[n].dataInfo._dataRanges.push({
              min: Infinity,
              max: -Infinity
            });
          }
      ...
      if (f) {
        for (n = 0; n < this.plotInfo.plotTypes.length; n++) {
          for (f = this.plotInfo.plotTypes[n], m = 0; m < f.plotUnits.length; m++) {
            b = f.plotUnits[m], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b);
          }
        }

        for (n = 0; n < this._axes.length; n++) {
          if (this._axes[n].dataInfo._dataRanges) {
            ...
            if (this._axes[n].dataInfo.dataPointYPositiveSums) {
              ...
              for (m in p) {
                if (p.hasOwnProperty(m) && !isNaN(m) && (q = p[m], !s(q))) {
            ...
            if (this._axes[n].dataInfo.dataPointYNegativeSums) {
              ...
              for (m in p) {
                p.hasOwnProperty(m) && !isNaN(m) && (q = -1 * p[m], s(q) || (g = Math.floor((q - A) / b), q < r[g].min && (r[g].min = q), q > r[g].max && (r[g].max = q)));
              }
            ...
            for (m = 0; m < h.length - 1; m++) {
              if (r = h[m].max, isFinite(r)) for (; m < h.length - 1;) {
                if (A = h[m + 1].min, isFinite(A)) {
                  q = A - r;
                  q > b && f.push({
                    diff: q,
                    start: r,
            ...
            if (this._axes[n].scaleBreaks.customBreaks) for (m = 0; m < this._axes[n].scaleBreaks.customBreaks.length; m++) {
              for (b = 0; b < f.length; b++) {
                if (this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].startValue && this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].end || f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue && this._axes[n].scaleBreaks.customBreaks[m].endValue <= f[b].end) f.splice(b, 1), b--;
              }
            }
            f.sort(function (a, b) {
            ...
            for (m = 0; m < Math.min(f.length, this._axes[n].scaleBreaks.maxNumberOfAutoBreaks); m++) {
              b = a(f[m].start, f[m].end, this._axes[n].logarithmic ? this._axes[n].dataInfo.max / this._axes[n].dataInfo.min : this._axes[n].dataInfo.max - this._axes[n].dataInfo.min, this._axes[n].logarithmic), this._axes[n].scaleBreaks.autoBreaks.push(new U(this, "autoBreaks", b, m, ++this._eventManager.lastObjectId, this._axes[n].scaleBreaks)), this._axes[n].scaleBreaks._appliedBreaks.push(this._axes[n].scaleBreaks.autoBreaks[this._axes[n].scaleBreaks.autoBreaks.length - 1]);
            }
    ...
    l.prototype.getDataPointAtXY = function (a, d, c) {
      ...
      for (c = 0; c < b.length; c++) {
        if ("line" === b[c].dataSeries.type || "stepLine" === b[c].dataSeries.type || "area" === b[c].dataSeries.type || "stepArea" === b[c].dataSeries.type) if (e = la("markerSize", b[c].dataPoint, b[c].dataSeries) || 8, b[c].distance <= e / 2) {
          d = !0;
          break;
        }
      }
    ...
    l.prototype._plotAreaMouseUp = function (a, d) {
      ...
      if ("none" !== this.plotInfo.axisPlacement) {
        this.resetOverlayedCanvas();
        if (this.axisX && 0 < this.axisX.length) for (n = 0; n < this.axisX.length; n++) {
          this.axisX[n].crosshair && this.axisX[n].crosshair.enabled && this.axisX[n].renderCrosshair(a, d);
        }
        if (this.axisX2 && 0 < this.axisX2.length) for (n = 0; n < this.axisX2.length; n++) {
          this.axisX2[n].crosshair && this.axisX2[n].crosshair.enabled && this.axisX2[n].renderCrosshair(a, d);
        }
        if (this.axisY && 0 < this.axisY.length) for (n = 0; n < this.axisY.length; n++) {
          this.axisY[n].crosshair && this.axisY[n].crosshair.enabled && this.axisY[n].renderCrosshair(a, d);
        }
        if (this.axisY2 && 0 < this.axisY2.length) for (n = 0; n < this.axisY2.length; n++) {
          this.axisY2[n].crosshair && this.axisY2[n].crosshair.enabled && this.axisY2[n].renderCrosshair(a, d);
        }
      }
    };
    ...
    l.prototype.validateRegion = function (a, d, c, b, e) {
      ...
      for (var f = 0 <= this.zoomType.indexOf("x"), n = 0 <= this.zoomType.indexOf("y"), m = !1, A = [], h = [], r = [], q = 0; q < this._axes.length; q++) {
        ("axisX" === this._axes[q].type && f || "axisY" === this._axes[q].type && n) && h.push(this._axes[q]);
      }
      ...
      for (n = 0; n < h.length; n++) {
        ...
        if (p > g) var C = g,
            g = p,
            p = C;
        if (q.scaleBreaks) for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++) {
          f = q.scaleBreaks._appliedBreaks[C].startValue <= p && q.scaleBreaks._appliedBreaks[C].endValue >= g;
        }
    ...
    l.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        h = this._indexLabels[a], g = la("indexLabelBackgroundColor", h.dataPoint, h.dataSeries), h.dataSeries.indexLabelBackgroundColor = s(g) ? t ? "transparent" : null : g;
      }
    ...
    l.prototype.renderLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            for (var D = !1, u = 0; u < r.length; u++) {
              if (x = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !D))) if ("number" !== typeof r[u].y) 0 < u && !(h.connectNullData || D || l) && (c.stroke(), t && b.stroke()), D = !0;else {
    ...
    l.prototype.renderStepLine = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            for (var D = !1, u = 0; u < r.length; u++) {
              if (x = r[u].getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !D))) if ("number" !== typeof r[u].y) 0 < u && !(h.connectNullData || D || l) && (c.stroke(), t && b.stroke()), D = !0;else {
                var y = s;
                x = a.axisX.convertValueToPixel(x);
                s = a.axisY.convertValueToPixel(r[u].y);
      ...
      function d(a) {
        ...
        if (0 < a.length) {
          ...
          for (var c = 0; c < a.length - 3; c += 3) {
            if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), t && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), 0 < c && 0 === c % 3E3 || a[c + 3].newStrokeStyle || a[c + 3].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(a[c + 3].x, a[c + 3].y), a[c + 3].newStrokeStyle && (b.strokeStyle = a[c + 3].newStrokeStyle), a[c + 3].newLineDashArray && b.setLineDash(a[c + 3].newLineDashArray), t && (e.stroke(), e.beginPath(), e.moveTo(a[c + 3].x, a[c + 3].y));
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var n = [], m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          var l = 0,
              ...
              z = [];
          b.beginPath();
          if (0 < r.length) for (s = !1, l = 0; l < r.length; l++) {
            if (u = r[l].getTime ? r[l].x.getTime() : r[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !s))) if ("number" !== typeof r[l].y) 0 < l && !s && (h.connectNullData ? b.setLineDash && 0 < z.length && (h.options.nullDataLineDashType || !r[l - 1].lineDashType) && (z[z.length - 1].newLineDashArray = p, q = h.nullDataLineDashType) : (d(z), z = [])), s = !0;else {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (r = 0; r < a.dataSeriesIndexes.length; r++) {
          var p = a.dataSeriesIndexes[r],
              g = this.data[p],
              C = g.dataPoints;
          if (0 < C.length) for (var k = 5 < q && g.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++) {
            if (C[f].getTime ? A = C[f].x.getTime() : A = C[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          ...
          if (0 < u.length) {
            ...
            for (h = 0; h < u.length; h++) {
              if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
          var k = a.dataSeriesIndexes[C],
              l = this.data[k],
              u = l.dataPoints;
          if (0 < u.length) for (var s = 5 < g && l.bevelEnabled ? !0 : !1, h = 0; h < u.length; h++) {
            if (b = u[h].x.getTime ? u[h].x.getTime() : u[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[h].y) {
              r = a.axisX.convertValueToPixel(b);
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < C.length) {
            ...
            for (var ka = !0; k < C.length; k++) {
              if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ka))) if ("number" !== typeof C[k].y) g.connectNullData || ka || d || b(), ka = !0;else {
      ...
      function d() {
        ...
        if (0 < c.length) {
          ...
          for (d = 0; d < c.length - 3; d += 3) {
            b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), t && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y);
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
          ...
          if (0 < q.length) {
            ...
            for (C = !1; p < q.length; p++) {
              if (g = q[p].x.getTime ? q[p].x.getTime() : q[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C))) if ("number" !== typeof q[p].y) 0 < p && !C && (r.connectNullData ? b.setLineDash && 0 < s.length && (r.options.nullDataLineDashType || !q[p - 1].lineDashType) && (s[s.length - 1].newLineDashArray = w, B = r.nullDataLineDashType) : (d(), s = [])), C = !0;else {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < C.length) {
            ...
            for (; k < C.length; k++) {
              if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !c))) {
                var Z = u;
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], D = 0; D < a.dataSeriesIndexes.length; D++) {
          ...
          for (p = 0; p < v.length; p++) {
            y = v[p].x.getTime ? v[p].x.getTime() : v[p].x, B.dataPointIndexes[y] = p, e[y] || (r.push(y), e[y] = !0);
          }
    ...
    l.prototype.renderBubble = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++) {
          for (var r = a.dataSeriesIndexes[h], q = this.data[r], p = q.dataPoints, g = 0, e = 0; e < p.length; e++) {
            f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[e].z || (g = p[e].z, g > m && (m = g), g < k && (k = g));
          }
        }

        for (var l = 25 * Math.PI, s = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l), h = 0; h < a.dataSeriesIndexes.length; h++) {
          if (r = a.dataSeriesIndexes[h], q = this.data[r], p = q.dataPoints, 0 < p.length) for (c.strokeStyle = "#4572A7 ", e = 0; e < p.length; e++) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            ...
            for (var q = 0, p = 0, e = 0; e < r.length; e++) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var fa = 0; fa < a.dataSeriesIndexes.length; fa++) {
          var da = a.dataSeriesIndexes[fa],
              u = this.data[da],
              x = u.dataPoints;
          if (0 < x.length) for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++) {
            if (x[m].getTime ? g = x[m].x.getTime() : g = x[m].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] && "number" === typeof x[m].y[1] && "number" === typeof x[m].y[2] && "number" === typeof x[m].y[3]) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var fa = !1, fa = !!a.axisY.reversed, da = 0; da < a.dataSeriesIndexes.length; da++) {
          var u = a.dataSeriesIndexes[da],
              x = this.data[u],
              z = x.dataPoints;
          if (0 < z.length) for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++) {
            if (z[n].getTime ? g = z[n].x.getTime() : g = z[n].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(z[n].y) && z[n].y.length && "number" === typeof z[n].y[0] && "number" === typeof z[n].y[1] && "number" === typeof z[n].y[2] && "number" === typeof z[n].y[3] && "number" === typeof z[n].y[4] && 5 === z[n].y.length) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
          var q = a.dataSeriesIndexes[r],
              p = this.data[q],
              g = p.dataPoints;
          if (0 < g.length) for (var l = 5 < h && p.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++) {
            if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(g[f].y) && g[f].y.length && "number" === typeof g[f].y[0] && "number" === typeof g[f].y[1]) {
    ...
    l.prototype.renderError = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var v = 0, u = 0; u < this.data.length; u++) {
          !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && v || v++;
        }
        ...
        for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
          var z = a.dataSeriesIndexes[x],
              ...
              E = 0;
          if (B) for (e = D._linkedSeries.id, u = 0; u < e; u++) {
            !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && E || (this.data[u].type.match(/(range)/ig) && (f = !0), E++);
          }
          e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
        ...
        for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
          ...
          if (0 < l.length) {
            ...
            for (f = 0; f < l.length; f++) {
              if (l[f].getTime ? h = l[f].x.getTime() : h = l[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(l[f].y) && l[f].y.length && "number" === typeof l[f].y[0] && "number" === typeof l[f].y[1]) {
      ...
      function d() {
        if (x) {
          ...
          for (var c = k.length - 1; 0 <= c; c--) {
            a = k[c], b.lineTo(a.x, a.y), e.lineTo(a.x, a.y);
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < q.length) {
            ...
            for (var T = !0; g < q.length; g++) {
              if (u = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !T))) if (null !== q[g].y && q[g].y.length && "number" === typeof q[g].y[0] && "number" === typeof q[g].y[1]) {
      ...
      function d(a, c) {
        ...
        if (0 < d.length) {
          ...
          for (f = 0; f < d.length - 3; f += 3) {
            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y), t && e.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
          }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
          ...
          if (0 < r.length) {
            ...
            for (g = !1; q < r.length; q++) {
              if (p = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g))) if (null !== r[q].y && r[q].y.length && "number" === typeof r[q].y[0] && "number" === typeof r[q].y[1]) {
    ...
    l.prototype.renderWaterfall = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < v.length) for (var z = 5 < p && s.bevelEnabled ? !0 : !1, D = !1, y = null, B = null, n = 0; n < v.length; n++) {
            if (v[n].getTime ? r = v[n].x.getTime() : r = v[n].x, "number" !== typeof v[n].y) {
    ...
    l.prototype.renderPie = function (a) {
      function d() {
        if (h && r) {
          ...
          for (e = 0; e < r.length; e++) {
            m = g[(c + e) % r.length], 1 < a && m.midAngle > Math.PI / 2 - u && m.midAngle < Math.PI / 2 + u && (f <= a / 2 && !q ? (m.hemisphere = "right", f++) : (m.hemisphere = "left", q = !0));
          }

          q = !1;

          for (e = 0; e < r.length; e++) {
            m = g[(d + e) % r.length], 1 < b && m.midAngle > 3 * Math.PI / 2 - u && m.midAngle < 3 * Math.PI / 2 + u && (n <= b / 2 && !q ? (m.hemisphere = "left", n++) : (m.hemisphere = "right", q = !0));
          }
        }
      }
      ...
      function e(a) {
        for (var c = null, d = 1; d < r.length; d++) {
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < r.length) {
          ...
          for (n = 1; n < r.length; n++) {
            if (m = (a - n + g.length) % g.length, g[m].hemisphere !== g[a].hemisphere) {
              m = null;
              break;
      ...
      function n() {
        ...
        for (var c = a = 0, d = 0, m = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (var u, s, a = 0; a < r.length; a++) {
              ...
              if (null !== y) {
                ...
                if (0 > D) {
                  for (var F = s = 0, J = 0; J < r.length; J++) {
                    J !== a && g[J].hemisphere === n.hemisphere && (g[J].indexLabelTextBlock.y < n.indexLabelTextBlock.y ? s++ : F++);
                  }
          ...
          (function () {
            for (var a = -1, c = -1, d = 0, f = !1, h = 0; h < r.length; h++) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < r.length; y++) {
          D += Math.abs(r[y].y), !a && "undefined" !== typeof r[y].indexLabel && null !== r[y].indexLabel && 0 < r[y].indexLabel.toString().length && (a = !0), !a && "undefined" !== typeof r[y].label && null !== r[y].label && 0 < r[y].label.toString().length && (a = !0);
        }
    ...
    l.prototype.renderFunnel = function (a) {
      ...
      function c() {
        ...
        for (var n = d[0] = 0, m = 0, k, r, b = b - a, n = !1, h = 0; h < x.length; h++) {
          a = Math.abs(x[h].y) * f / g, n ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (r = aa * aa * b * b - 4 * Math.abs(aa) * a, 0 > r ? (r = c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += 0 == r ? 0 : a / r, m += a / r, n = !0) : (k = (Math.abs(aa) * b - Math.sqrt(r)) / 2, r = b - 2 * k / Math.abs(aa), m += k, m > e && (m -= k, r = c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += a / r, m += a / r, n = !0), b = r)), d.push(k);
        }
      ...
      function b() {
        if (u && x) {
          for (var a, b, c, d, e, f, h, m, n, k, r, p, q, l, A = [], C = [], v = {
            percent: null,
            total: null
          }, z = null, y = 0; y < x.length; y++) {
            l = O[y], l = "undefined" !== typeof l.x5 ? (l.y2 + l.y4) / 2 : (l.y2 + l.y3) / 2, l = g(l).x2 + 1, A[y] = M - l - V;
          }
      ...
      function e() {
        ...
        if (e) for (m = H.length - 1; 0 <= m; m--) {
          a = O[m], H[m].textBlock.maxWidth = f[f.length - (m + 1)], H[m].textBlock.measureText(), H[m].textBlock.x = M - h, c = H[m].textBlock.height < H[m].textBlock.maxHeight ? H[m].textBlock.height : H[m].textBlock.maxHeight, e = H[m].textBlock.width < H[m].textBlock.maxWidth ? H[m].textBlock.width : H[m].textBlock.maxWidth, H[m].height = c, H[m].width = e, c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, H[m].textBlock.y = c - H[m].height / 2, u.reversed ? (H[m].textBlock.y + H[m].height > na + D && (H[m].textBlock.y = na + D - H[m].height), H[m].textBlock.y < sa - D && (H[m].textBlock.y = sa - D)) : (H[m].textBlock.y < na - D && (H[m].textBlock.y = na - D), H[m].textBlock.y + H[m].height > sa + D && (H[m].textBlock.y = sa + D - H[m].height));
        }
      }

      function f() {
        var a, b, c, d;
        if ("inside" !== u.indexLabelPlacement) for (var e = 0; e < O.length; e++) {
          0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? g(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? g(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y = c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > na + D && (H[e].textBlock.y = na + D - H[e].height), H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D)) : (H[e].textBlock.y < na - D && (H[e].textBlock.y = na - D), H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
        } else for (e = 0; e < O.length; e++) {
          0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = O[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != ba ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != ba ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y = c) : H[e].isDirty = !0);
        }
      }
      ...
      function n() {
        ...
        function b() {
          ...
          for (var m, n = 1; n < h; n++) {
            ...
            for (var r = H.length - 1; 0 <= r; r--) {
              !H[r].isDirty && H[r].textBlock.y < e && H[r].textBlock.y + H[r].height > e && (m = p(r), !(m >= H.length - 1) && H[r].textBlock.y + H[r].height + ca > H[m].textBlock.y && (H[r].textBlock.y = H[r].textBlock.y + H[r].height - e > e - H[r].textBlock.y ? e + 1 : e - H[r].height - 1));
            }
          }
        ...
        function c(a, b, d) {
          ...
          for (d = 0; d < e.length; d++) {
            if (b = e[d], f < a) g++, f += H[b.id].height + ca, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText();else break;
          }
        ...
        var s = {
          ...
          changeSection: function changeSection(a) {
            for (var b, c, d = 0; d < O.length; d++) {
              b = g[d], c = O[d], b *= a, "undefined" === typeof q[d] && (q[d] = 0), 0 > q && (q *= -1), c.y1 += b - q[d], c.y2 += b - q[d], c.y3 += b - q[d], c.y4 += b - q[d], c.y5 && (c.y5 += b - q[d], c.y6 += b - q[d]), q[d] = b;
            }
          }
        };
      ...
      function h() {
        for (var a = 0, b = 0; b < O.length - 1; b++) {
          (0 <= Y.indexOf(b) || 0 <= Y.indexOf(b + 1)) && a++;
        }
      ...
      function l(a) {
        for (var b = 0; b < O.length; b++) {
          H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0));
        }
      }
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, F = Math.min(z.width - 2 * y, 2.8 * z.height), I = !1, S = 0; S < x.length; S++) {
          if (!I && "undefined" !== typeof x[S].indexLabel && null !== x[S].indexLabel && 0 < x[S].indexLabel.toString().length && (I = !0), !I && "undefined" !== typeof x[S].label && null !== x[S].label && 0 < x[S].label.toString().length && (I = !0), !I && "function" === typeof u.indexLabelFormatter || "function" === typeof x[S].indexLabelFormatter) I = !0;
        }
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
          ...
          if (-1 !== S) {
            if (u.reversed) for (F.push(U), G = S.length - 1; 0 < G; G--) {
              U += S[G], F.push(U);
            } else for (G = 0; G < S.length; G++) {
              U += S[G], F.push(U);
            }
            if (u.reversed) for (G = 0; G < S.length; G++) {
              F[G] < xa ? (a.push(K), y.push(W), ba = G) : (a.push((F[G] - na + aa * X) / aa), y.push((F[G] - na + ea * $) / ea));
            } else for (G = 0; G < S.length; G++) {
              F[G] < xa ? (a.push((F[G] - na + aa * X) / aa), y.push((F[G] - na + ea * $) / ea), ba = G) : (a.push(K), y.push(W));
            }

            for (G = 0; G < S.length - 1; G++) {
              U = u.reversed ? x[x.length - 1 - G].color ? x[x.length - 1 - G].color : u._colorSet[(x.length - 1 - G) % u._colorSet.length] : x[G].color ? x[G].color : u._colorSet[G % u._colorSet.length], G === ba ? O.push({
                x1: a[G],
                y1: F[G],
                x2: y[G],
                y2: F[G],
            ...
            for (G = 0; G < x.length; G++) {
              x[G].exploded && (S = !0, u.reversed ? Y.push(x.length - 1 - G) : Y.push(G));
            }
            ...
            if (I && u.visible && (b(), f(), e(), "inside" !== u.indexLabelPlacement)) {
              ...
              for (G = 0; G < x.length; G++) {
                H[G].isDirty || (a = H[G].textBlock.x + H[G].width, a = (M - a) / 2, 0 == G && (B = a), B > a && (B = a));
              }

              for (G = 0; G < O.length; G++) {
                O[G].x1 += B, O[G].x2 += B, O[G].x3 += B, O[G].x4 += B, O[G].x5 && (O[G].x5 += B, O[G].x6 += B), H[G].textBlock.x += B;
              }
            }

            for (G = 0; G < O.length; G++) {
              B = O[G], qa(Q, B, u.fillOpacity), ha.push(B.y1);
            }

            v(Q);
            I && u.visible && ("inside" === u.indexLabelPlacement || w.animationEnabled || r(Q), w.animationEnabled || l());
            if (!I) for (G = 0; G < x.length; G++) {
              B = u.dataPointIds[G], a = {
                id: B,
                objectType: "dataPoint",
                dataPointIndex: G,
                dataSeriesIndex: 0,
    ...
    l.prototype.exportChart = function (a) {
      ...
      if (b && d && c) {
        ...
        if ("undefined" !== typeof Blob && new Blob()) {
          for (var n = b.replace(/^data:[a-z\/]*;base64,/, ""), n = atob(n), m = new ArrayBuffer(n.length), m = new Uint8Array(m), k = 0; k < n.length; k++) {
            m[k] = n.charCodeAt(k);
          }
    ...
    F.prototype.setLayout = function () {
      ...
      for (r = 0; r < this.items.length; r++) {
        p = k[r], p.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[p.id] = {
          id: p.id,
    ...
    E.prototype.createExtraLabelsForLog = function (a) {
      ...
      if (!(5 < a)) {
        ...
        if (Math.log(this.range) / Math.log(d / this.viewportMinimum) < this.noTicks - 1) {
          for (var c = E.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c) {
    ...
    E.prototype.createLabels = function () {
      ...
      if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
        ...
        if (this.logarithmic && !this.equidistantInterval) for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = p; b < this.logLabelValues.length; b++) {
          ...
          for (c = 0; c < this._labels.length; c++) {
            if (!this._labels[c].breaksLabelType) {
              ...
              for (var v, g = a.text.split(" "), b = 0; b < g.length; b++) {
                l = g[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, l = this.ctx.measureText(l), l.width > p && (v = c, p = l.width);
              }
            }
          }
    ...
    E.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < p.length; g++) {
        if (p[g] && p[g].scaleBreaks && p[g].scaleBreaks._appliedBreaks.length) for (var t = p[g].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > p[g].viewportMaximum); v++) {
          t[v].endValue < p[g].viewportMinimum || (s(p[g].scaleBreaks.firstBreakIndex) && (p[g].scaleBreaks.firstBreakIndex = v), t[v].startValue >= p[g].viewPortMinimum && (p[g].scaleBreaks.lastBreakIndex = v));
        }
      }

      for (var w = v = 0, u = 0, x = 0, z = 0, D = 0, y = 0, B, E, F = m = 0, I, J, L, t = I = J = L = !1, g = 0; g < p.length; g++) {
        p[g] && p[g].title && (p[g]._titleTextBlock = new ja(p[g].ctx, {
          text: p[g].title,
          horizontalAlign: "center",
      ...
      for (g = 0; g < p.length; g++) {
        if (p[g].title) switch (p[g]._position) {
          case "left":
      ...
      if ("normal" === e) {
        for (var x = [], z = [], D = [], y = [], M = [], N = [], P = [], Q = []; 4 > v;) {
          var G = 0,
              ...
              O = 0,
              aa = 0;
          if (c && 0 < c.length) for (D = [], g = O = 0; g < c.length; g++) {
            D.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += D[g], K += c[g] && !l.isNavigator ? c[g].margin : 0;
          } else D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
          P.push(D);
          if (b && 0 < b.length) for (y = [], g = aa = 0; g < b.length; g++) {
            y.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), aa += y[g], $ += b[g] ? b[g].margin : 0;
          ...
          if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
            d[g].lineCoordinates.x1 = Math.round(f.x1 + O + K), d[g].lineCoordinates.x2 = Math.round(f.x2 - aa - $ > l.width - q ? l.width - q : f.x2 - aa - $), d[g].lineCoordinates.width = Math.abs(k - n), d[g]._labels && 1 < d[g]._labels.length && (h = d[g]._labels[1], m = "dateTime" === d[g].valueType ? d[g]._labels[d[g]._labels.length - 2] : d[g]._labels[d[g]._labels.length - 1], w = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(h.textBlock.angle)), u = m.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(m.textBlock.angle)) + (m.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(m.textBlock.angle))), l.panEnabled ? W = s(l.sessionVariables.axisX2.height) ? l.sessionVariables.axisX2.height = W : l.sessionVariables.axisX2.height : l.sessionVariables.axisX2.height = W, m = Math.round(f.y1), h = Math.round(f.y2 + d[g].margin), d[g].lineCoordinates.y1 = m + W + X - R, d[g].lineCoordinates.y2 = m, "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - z[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)), d[g].bounds = {
              x1: n,
              y1: m + (W + X - z[g] - R),
              x2: k,
              y2: h,
          ...
          for (g = 0; g < p.length; g++) {
            "axisY" === p[g].type && (p[g].calculateValueToPixelConversionParameters(), p[g].calculateBreaksSizeInValues());
          }
        ...
        for (N = []; 4 > v;) {
          ...
          if (a && 0 < a.length) for (F = [], g = Y = 0; g < a.length; g++) {
            F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), Y += F[g], e += a[g] && !l.isNavigator ? a[g].margin : 0;
          ...
          if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) {
            b[g] && (m = Math.round(f.y1), h = Math.round(f.y1 + (B[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - B[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
              x1: n,
              y1: m + (b[g].margin + G),
              x2: k,
              y2: h,
          ...
          if (a && 0 < a.length) for (g = 0; g < a.length; g++) {
            ...
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) {
              c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - Y : n);
            }
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) {
              b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1, n = k - Y);
            }
            a[g].lineCoordinates = {
              x1: k - P,
              y1: m,
          ...
          if (d && 0 < d.length) for (g = 0; g < d.length; g++) {
            ...
            h = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - V > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2 - V) : f.y2 > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2;
            if (c && 0 < c.length) for (K = 0; K < c.length; K++) {
              c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : n);
            }
            if (b && 0 < b.length) for (K = 0; K < b.length; K++) {
              b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, n = k - U);
            }
            d[g].lineCoordinates = {
              x1: k + Q,
              y1: m,
    ...
    E.render = function (a, d, c, b, e) {
      ...
      e.clip();
      if (a && 0 < a.length) for (var m = 0; m < a.length; m++) {
        a[m].renderLabelsTicksAndTitle();
      }
      if (d && 0 < d.length) for (m = 0; m < d.length; m++) {
        d[m].renderLabelsTicksAndTitle();
      }
      e.restore();
      if (c && 0 < c.length) for (m = 0; m < c.length; m++) {
        c[m].renderLabelsTicksAndTitle();
      }
      if (b && 0 < b.length) for (m = 0; m < b.length; m++) {
        b[m].renderLabelsTicksAndTitle();
      }
      f.preparePlotArea();
      f = f.plotArea;
      e.save();
      ...
      e.clip();
      if (a && 0 < a.length) for (m = 0; m < k.length; m++) {
        k[m].renderStripLinesOfThicknessType("value");
      }
      if (d && 0 < d.length) for (m = 0; m < d.length; m++) {
        d[m].renderStripLinesOfThicknessType("value");
      }
      if (c && 0 < c.length) for (m = 0; m < c.length; m++) {
        c[m].renderStripLinesOfThicknessType("value");
      }
      if (b && 0 < b.length) for (m = 0; m < b.length; m++) {
        b[m].renderStripLinesOfThicknessType("value");
      }
      if (a && 0 < a.length) for (m = 0; m < a.length; m++) {
        a[m].renderInterlacedColors();
      }
      if (d && 0 < d.length) for (m = 0; m < d.length; m++) {
        d[m].renderInterlacedColors();
      }
      if (c && 0 < c.length) for (m = 0; m < c.length; m++) {
        c[m].renderInterlacedColors();
      }
      if (b && 0 < b.length) for (m = 0; m < b.length; m++) {
        b[m].renderInterlacedColors();
      }
      e.restore();
      if (a && 0 < a.length) for (m = 0; m < a.length; m++) {
        a[m].renderGrid(), t && (a[m].createMask(), a[m].renderBreaksBackground());
      }
      if (d && 0 < d.length) for (m = 0; m < d.length; m++) {
        d[m].renderGrid(), t && (d[m].createMask(), d[m].renderBreaksBackground());
      }
      if (c && 0 < c.length) for (m = 0; m < c.length; m++) {
        c[m].renderGrid(), t && (c[m].createMask(), c[m].renderBreaksBackground());
      }
      if (b && 0 < b.length) for (m = 0; m < b.length; m++) {
        b[m].renderGrid(), t && (b[m].createMask(), b[m].renderBreaksBackground());
      }
      if (a && 0 < a.length) for (m = 0; m < a.length; m++) {
        a[m].renderAxisLine();
      }
      ...
      if (a && 0 < a.length) for (m = 0; m < a.length; m++) {
        a[m].renderStripLinesOfThicknessType("pixel");
      }
      if (d && 0 < d.length) for (m = 0; m < d.length; m++) {
        d[m].renderStripLinesOfThicknessType("pixel");
      }
      if (c && 0 < c.length) for (m = 0; m < c.length; m++) {
        c[m].renderStripLinesOfThicknessType("pixel");
      }
      if (b && 0 < b.length) for (m = 0; m < b.length; m++) {
        b[m].renderStripLinesOfThicknessType("pixel");
      }
    };
    ...
    E.prototype.calculateBreaksSizeInValues = function () {
      for (var a = "left" === this._position || "right" === this._position ? this.lineCoordinates.height || this.chart.height : this.lineCoordinates.width || this.chart.width, d = this.scaleBreaks ? this.scaleBreaks._appliedBreaks : [], c = this.conversionParameters.pixelPerUnit || a / (this.logarithmic ? this.conversionParameters.maximum / this.conversionParameters.minimum : this.conversionParameters.maximum - this.conversionParameters.minimum), b = this.scaleBreaks && !s(this.scaleBreaks.options.spacing), e, f = 0; f < d.length; f++) {
        e = b || !s(d[f].options.spacing), d[f].spacing = Sa(d[f].spacing, a, 8, e ? 0.1 * a : 8, e ? 0 : 3) << 0, d[f].size = 0 > d[f].spacing ? 0 : Math.abs(d[f].spacing / c), this.logarithmic && (d[f].size = Math.pow(this.logarithmBase, d[f].size));
      }
    };
    ...
    E.prototype.renderLabelsTicksAndTitle = function () {
      ...
      if ("undefined" === typeof this.options.interval) {
        if ("bottom" === this._position || "top" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          ...
          for (h = 0; h < this._labels.length; h++) {
            q = this._labels[h], q.position < this.viewportMinimum || (k = q.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += k);
          }
        ...
        if ("left" === this._position || "right" === this._position) if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
          ...
          for (h = 0; h < this._labels.length; h++) {
            q = this._labels[h], q.position < this.viewportMinimum || (r = q.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + q.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), b += r);
          }
      ...
      if ("bottom" === this._position) {
        ...
        "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function () {
          for (h = 0; h < a._labels.length; h++) {
            if (q = a._labels[h], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
      ...
      if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function () {
        for (h = 0; h < a._labels.length; h++) {
          q = a._labels[h], q.position < a.viewportMinimum || q.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit || (a.ctx.save(), a.ctx.beginPath(), q.textBlock.render(!0), a.ctx.restore());
        }
      }, this);else for (h = 0; h < this._labels.length; h++) {
        q = this._labels[h], q.position < this.viewportMinimum || q.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit || q.textBlock.render(!0);
      }
    };
      ...
      if (this.stripLines && 0 < this.stripLines.length && a) {
        ...
        if (!k) {
          ...
          for (b = 0; b < m.length; b++) {
            h = m[b], h.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
              this.ctx.save();
              this.ctx.beginPath();
              this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
              this.ctx.clip();
          ...
          for (b = 0; b < l.length; b++) {
            c = l[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
              for (e = 0; e < l.length; e++) {
                c = l[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore());
              }
        ...
        if (k) for (k = !1, b = 0; b < l.length; b++) {
          c = l[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
            for (e = 0; e < l.length; e++) {
              c = l[e], "outside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && c.textBlock.render(!0);
            }
    ...
    E.prototype.renderAxisLine = function () {
      ...
      if ("bottom" === this._position || "top" === this._position) {
        if (this.lineThickness) {
          ...
          d.beginPath();
          if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;else for (var m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) {
            d.moveTo(e, k), d.lineTo(this.scaleBreaks._appliedBreaks[m].startPixel + c, k), e = this.scaleBreaks._appliedBreaks[m].endPixel + b;
          }
        ...
        d.beginPath();
        if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;else for (m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) {
          d.moveTo(k, e), d.lineTo(k, this.scaleBreaks._appliedBreaks[m].startPixel + b), e = this.scaleBreaks._appliedBreaks[m].endPixel + c;
        }
    ...
    E.prototype.calculateLogarithmicAxisParameters = function () {
      ...
      if (this.scaleBreaks) for (k = 0; k < this.scaleBreaks._appliedBreaks.length; k++) {
      ...
      if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
        ...
        if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position) {
          if (b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, m = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
            ...
            for (var p = 0; p < r; p++) {
              this.ctx.bezierCurveTo(l + f * a, h + a, l + f * a, h + 2 * a, l, h + 3 * a), h += 3 * a, f *= -1;
            }
            ...
            if ("zigzag" === this.type) {
              ...
              for (p = 0; p < r; p++) {
                this.ctx.lineTo(l, h), l += 2 * f * a, h += 2 * a, f *= -1;
              }
          ...
          for (p = 0; p < r; p++) {
            this.ctx.bezierCurveTo(l + a, h + f * a, l + 2 * a, h + f * a, l + 3 * a, h), l += 3 * a, f *= -1;
          }
          ...
          for (p = 0; p < r; p++) {
            this.ctx.lineTo(l, h), h += 2 * f * a, l += 2 * a, f *= -1;
          }
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var w = 0; w < this.parent.dataSeries.length; w++) {
            (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (v.dataSeries = this.parent.dataSeries[w], null !== v.dataPoint.y && r.push(v));
          }
          ...
          w = 0;
          if ("rangeBar" === r[0].dataSeries.type || "error" === r[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(r[w].dataPoint.y[0])), u = 0, t = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (var x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
          } else if ("stackedBar" === r[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), z = u = 0, t = w = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else z += r[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, w = t);
          } else if ("stackedBar100" === r[0].dataSeries.type) for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), D = z = u = 0, t = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else z += r[t].dataPoint.y, D = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(a - this.parent.convertValueToPixel(D)), u < v && (v = u, w = t);
          } else for (v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = w = u = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
          }
          ...
          if ("bottom" === this.parent._position || "top" === this.parent._position) {
            ...
            if ("rangeBar" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type) {
              ...
              for (t = u = 0; t < x.dataPoint.y.length; t++) {
                u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[t])), u < v && (v = u, b = t);
              }
              ...
              for (t = w; 0 <= t; t--) {
                z += r[t].dataPoint.y, u = Math.abs(a - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
              }
              ...
              for (t = w; 0 <= t; t--) {
                z += r[t].dataPoint.y, D = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(a - this.parent.convertValueToPixel(D)), u < v && (v = u, b = t);
              }
            ...
            D = !1;
            if (this.parent.labels) for (r = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += r) {
              if (this.parent.labels[t]) D = !0;else {
                D = !1;
                break;
              }
            }
            ...
            if (D) {
              if ("axisX" === this.parent.type) for (t = this.parent.convertPixelToValue({
                ...
                (v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (h.text = this.labelFormatter ? this.labelFormatter({
                  chart: this.chart,
                  axis: this.parent.options,
                  crosshair: this.options,
                  value: x.dataPoint.x
          ...
          w = 0;
          if ("rangeColumn" === r[0].dataSeries.type || "rangeArea" === r[0].dataSeries.type || "error" === r[0].dataSeries.type || "rangeSplineArea" === r[0].dataSeries.type || "candlestick" === r[0].dataSeries.type || "ohlc" === r[0].dataSeries.type || "boxAndWhisker" === r[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y[0])), t = u = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
          } else if ("stackedColumn" === r[0].dataSeries.type || "stackedArea" === r[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = z = u = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else z += r[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, w = t);
          } else if ("stackedColumn100" === r[0].dataSeries.type || "stackedArea100" === r[0].dataSeries.type) for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = D = z = u = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else z += r[t].dataPoint.y, D = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(d - this.parent.convertValueToPixel(D)), u < v && (v = u, w = t);
          } else for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = u = 0; t < r.length; t++) {
            if (r[t].dataPoint.y && r[t].dataPoint.y.length) for (x = 0; x < r[t].dataPoint.y.length; x++) {
              u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
            } else u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
          }
          ...
          if ("rangeColumn" === this.parent.dataSeries[w].type || "rangeArea" === this.parent.dataSeries[w].type || "error" === this.parent.dataSeries[w].type || "rangeSplineArea" === this.parent.dataSeries[w].type || "candlestick" === this.parent.dataSeries[w].type || "ohlc" === this.parent.dataSeries[w].type || "boxAndWhisker" === this.parent.dataSeries[w].type) {
            ...
            for (t = u = 0; t < x.dataPoint.y.length; t++) {
              u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[t])), u < v && (v = u, b = t);
            }
            ...
            for (t = w; 0 <= t; t--) {
              z += r[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, b = t);
            }
            ...
            for (t = w; 0 <= t; t--) {
              z += r[t].dataPoint.y, D = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, D = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[D]), u = Math.abs(d - this.parent.convertValueToPixel(D)), u < v && (v = u, b = t);
            }
    ...
    X.prototype._updateToolTip = function (a, d, c) {
      ...
      if (!this.chart.disableToolTip) {
        ...
        if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
          if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
            ...
            if (this.chart.axisX) for (var l = 0; l < this.chart.axisX.length; l++) {
              for (var k = this.chart.axisX[l].convertPixelToValue({
                y: d
              }), h = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++) {
                (h = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
              }
            ...
            if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) {
              ...
              for (b = 0; b < this.chart.axisX2[l].dataSeries.length; b++) {
                (h = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
              }
            ...
            m = [];
            if (this.chart.axisX) for (l = 0; l < this.chart.axisX.length; l++) {
              for (k = this.chart.axisX[l].convertPixelToValue({
                x: a
              }), h = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++) {
                (h = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
              }
            ...
            if (this.chart.axisX2) for (l = 0; l < this.chart.axisX2.length; l++) {
              for (k = this.chart.axisX2[l].convertPixelToValue({
                x: a
              }), h = null, b = 0; b < this.chart.axisX2[l].dataSeries.length; b++) {
                (h = this.chart.axisX2[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[l].dataSeries[b], null !== h.dataPoint.y && m.push(h));
              }
            }
          }
          ...
          for (b = 0; b < m.length; b++) {
            m[b].dataPoint.x.valueOf() === c.dataPoint.x.valueOf() && f.push(m[b]);
          }
          ...
          if (0 <= this.currentSeriesIndex) {
            ...
            if (!s(h) && !s(h.dataPoint) && !s(h.dataPoint.y)) if (h.dataSeries.axisY) {
              if (0 < h.dataPoint.y.length) {
                for (b = c = 0; b < h.dataPoint.y.length; b++) {
                  h.dataPoint.y[b] < h.dataSeries.axisY.viewportMinimum ? c-- : h.dataPoint.y[b] > h.dataSeries.axisY.viewportMaximum && c++;
                }
    ...
    X.prototype.showAtX = function (a, d) {
      ...
      if (this.shared) for (var k = 0; k < this.chart.data.length; k++) {
        c = this.chart.data[k], (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !s(b.dataPoint.y) && c.visible && (b.dataSeries = c, f.push(b));
      } else c = this.chart.data[d], (b = c.getDataPointAtX(a, !1)) && b.dataPoint && !s(b.dataPoint.y) && c.visible && (b.dataSeries = c, f.push(b));

      if (0 < f.length) {
        for (k = 0; k < f.length; k++) {
          if (b = f[k], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;else {
            e = !1;
            break;
          }
        }
