...
/***/ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/pretty-checkbox/dist/pretty-checkbox.min.css":
/*!***************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/pretty-checkbox/dist/pretty-checkbox.min.css ***!
  \***************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!**************************************************************!*\
  !*** ./node_modules/pretty-checkbox-react/dist-web/index.js ***!
  \**************************************************************/
/*! exports provided: Checkbox, Group, Radio, RadioGroup, Switch, useCheckboxState, useRadioState, useSwitchState */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useCheckboxState", function() { return useCheckboxState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useRadioState", function() { return useRadioState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "useSwitchState", function() { return useSwitchState; });
...
const useIcon = (icon) => {
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => {
        if (icon) {
            ...
            return {
                iconType: type,
                icon: Object(react__WEBPACK_IMPORTED_MODULE_0__["cloneElement"])(icon, {
                    ...icon.props,
                    className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(icon.props.className, 'icon'),
                }),
            };
        }
        return {};
...
const getClassNames = ({ animation, icon, locked, bigger, plain, shape, fill, className, readOnly, isSwitch, iconType, }) => classnames__WEBPACK_IMPORTED_MODULE_1___default()('pretty', {
    'p-switch': isSwitch,
...
const PrettyInput = Object(react__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(({ onChange, disabled, value, state, locked, type, name, checked, defaultChecked, defaultValue, baseId, }, ref) => {
    return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("input", { onChange: onChange, type: type, value: value, name: name, id: baseId, tabIndex: -1, ref: ref, defaultChecked: defaultChecked, defaultValue: defaultValue, checked: typeof checked === 'undefined'
            ? getChecked({ state, value, disabled, locked, type })
            : checked, disabled: disabled }));
});
PrettyInput.displayName = 'Pretty.Input';

const PrettyLabel = ({ color, icon, children, baseId, }) => (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('state', {
        [`p-${color}`]: color,
    }) },
    icon,
    Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("label", { htmlFor: baseId }, children)));
...
const Pretty = Object(react__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])((props, ref) => {
    const { as = 'div', ...rest } = props;
    const { inputProps, labelProps, htmlProps } = organizeProps(rest);
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(as, {
        // @ts-ignore
        ...
        onKeyPress: Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])(
        /* istanbul ignore next */ (e) => {
            /* istanbul ignore next */
            e.preventDefault();
        }, []),
        onKeyUp: Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e) => {
        ...
        ...htmlProps,
    }, Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null,
        Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PrettyInput, Object.assign({ ref: ref }, inputProps)),
        Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PrettyLabel, Object.assign({}, labelProps))));
});
Pretty.displayName = 'Pretty';

const PREFIX = 'pcr_';
const useUUID = ({ prefix = PREFIX } = {}) => {
    const { current: baseId } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(prefix + Object(nanoid__WEBPACK_IMPORTED_MODULE_2__["nanoid"])(10));
    return { baseId };
};
...
const useCheckboxState = ({ state: initialState = false, } = {}) => {
    ...
    return {
        state,
        setState,
        onChange: Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((e, args) => {
...
const Checkbox = Object(react__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(({ value: userValue, icon: userIcon, ...rest }, ref) => {
    const { icon, iconType } = useIcon(userIcon);
    const value = typeof userValue === 'undefined' ? '' : userValue;
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Pretty, {
        type: 'checkbox',
        icon,
        iconType,
        value,
...
const Group = (props) => {
    ...
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(as, htmlProps, children);
};
...
const RadioGroup = (props) => (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Group, Object.assign({ as: "fieldset", role: "radiogroup" }, props)));
const Radio = Object(react__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(({ value: userValue, icon: userIcon, shape = 'round', ...rest }, ref) => {
    const { icon, iconType } = useIcon(userIcon);
    const value = typeof userValue === 'undefined' ? '' : userValue;
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Pretty, {
        type: 'radio',
...
const Switch = Object(react__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(({ value: userValue, ...rest }, ref) => {
    const value = typeof userValue === 'undefined' ? '' : userValue;
    return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Pretty, {
        type: 'checkbox',
        isSwitch: true,
...
var content = __webpack_require__(/*! !../../css-loader??ref--6-1!../../postcss-loader/src??ref--6-2!./pretty-checkbox.min.css */ "./node_modules/css-loader/index.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/pretty-checkbox/dist/pretty-checkbox.min.css");
...
/* harmony import */ var pretty_checkbox_react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! pretty-checkbox-react */ "./node_modules/pretty-checkbox-react/dist-web/index.js");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/esm/react-router-dom.js");
/* harmony import */ var pretty_checkbox__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! pretty-checkbox */ "./node_modules/pretty-checkbox/dist/pretty-checkbox.min.css");
/* harmony import */ var pretty_checkbox__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(pretty_checkbox__WEBPACK_IMPORTED_MODULE_6__);
...
var Login = function Login() {
  ...
  var handleCheck = Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function () {
    setRemember(function (prev) {
      return !prev;
    });
  }, []);
  react__WEBPACK_IMPORTED_MODULE_1___default.a.useEffect(function () {
    if (remember) {// perform some side effect
      // when the state changes
    }
  }, [remember]);

  var handleChange = function handleChange(event) {
    var inputs = _objectSpread({}, form);
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              response = axios.post('api/login', form);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    placeholder: "********",
    onChange: handleChange,
    className: "w-full border-b border-t-0 border-l-0 \r border-r-0 border-grey-dark \r focus:outline-none"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "absolute inset-y-0 right-0 pr-2 flex items-end text-sm leading-7"
  ...
  }, show ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("i", {
...
var Button = function Button(_ref) {
  var title = _ref.title,
      ...
      rest = _objectWithoutProperties(_ref, ["title", "type", "style", "onClick"]);

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", _extends({}, rest, {
    type: type || "button",
    onClick: onClick,
    className: "p-2 rounded w-full ".concat(style)
  }), title);
};
...
var TextInput = function TextInput(_ref) {
  var label = _ref.label,
      ...
      value = _ref.value,
      rest = _objectWithoutProperties(_ref, ["label", "name", "type", "placeholder", "value"]);

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "relative mb-4"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", {
    className: "block text-gray-500 text-sm font-semibold mb-2"
  }, label), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", _extends({}, rest, {
    name: name,
    value: value || "",
    type: type || "text",
    placeholder: placeholder,
    className: "w-full border-b border-t-0 border-l-0 border-r-0 border-grey-dark\r focus:outline-none"
  })));
};
...
module.exports = __webpack_require__(/*! C:\laragon\www\LoveLivesGenerously\resources\js\auth\Login.js */"./resources/js/auth/Login.js");
