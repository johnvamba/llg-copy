...
const EditStory = ({ setShowViewStory, setShowEditStory }) => {
                ...
                <section className="create-story__body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            <label>Title</label>
                            <input className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 leading-tight focus:outline-none" type="text" placeholder="Enter Title" defaultValue="Sample Text Here" />
                        </div>
